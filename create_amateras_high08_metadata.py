...
def create_high08_metadata(folder_FITS, folder_metadata):
    """
    Parameters:
    folder_FITS: str
    ...
    for filename in list_file:  # iterate all files in folder_FITS
        ...
        try:
            ...
            meta["access_url"] = (
                "http://octave.gp.tohoku.ac.jp/db/IPRT-SUN/l1/high08/{}/{}/{}".format(
                    header["DATE"][:4],
                    header["DATE"].replace("-", ""),
                    filename,
                )
        ...
        # Constant metadata
        meta["granule_gid"] = "IPRT AMATERAS High Resolution 8 bit Dataset"  # ??
...
if __name__ == "__main__":
    ...
    try:  # Verify folder_metadata is given
        ...
        folder_metadata = "./high08metadata/"
    ...
    if os.path.isdir(folder_FITS):
        ...
        create_high08_metadata(folder_FITS, folder_metadata)
